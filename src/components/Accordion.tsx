...
export function Accordion({ title, children, defaultOpen = false }: Props) {
  return (
    <details
      open={defaultOpen}
      className="group border border-gray-200 dark:border-gray-700 rounded-lg mb-3"
    >
      <summary className="flex items-center justify-between px-4 py-3 bg-gray-50 dark:bg-gray-800 hover:bg-gray-100 dark:hover:bg-gray-750 cursor-pointer select-none rounded-lg group-open:rounded-b-none">
